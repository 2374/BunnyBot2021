...
public class RobotContainer {
  ...
  private final InteractiveDriveCommand drivetrainCommand = new InteractiveDriveCommand(m_drivetrainSubsystem, m_intakeSubsystem);
  ...
  */
  ...
  public RobotContainer() {
    ...
    m_drivetrainSubsystem.setDefaultCommand(drivetrainCommand);
  }
